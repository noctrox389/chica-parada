...
function onUpdate()
	...
	noteTweenAlpha('noteAlphaTween1', 0, 0, 0.2)
	noteTweenAlpha('noteAlphaTween2', 1, 0, 0.2)
	noteTweenAlpha('noteAlphaTween3', 2, 0, 0.2)
	noteTweenAlpha('noteAlphaTween4', 3, 0, 0.2)
	noteTweenAlpha('noteAlphaTween5', 4, 0, 0.2)
	noteTweenAlpha('noteAlphaTween6', 5, 0, 0.2)
	noteTweenAlpha('noteAlphaTween7', 6, 0, 0.2)
	noteTweenAlpha('noteAlphaTween8', 7, 0, 0.2)
	...
	noteTweenAlpha('noteAlphaTween2.1', 0, 1, 0.2)
	noteTweenAlpha('noteAlphaTween2.2', 1, 1, 0.2)
	noteTweenAlpha('noteAlphaTween2.3', 2, 1, 0.2)
	noteTweenAlpha('noteAlphaTween2.4', 3, 1, 0.2)
	noteTweenAlpha('noteAlphaTween2.5', 4, 1, 0.2)
	noteTweenAlpha('noteAlphaTween2.6', 5, 1, 0.2)
	noteTweenAlpha('noteAlphaTween2.7', 6, 1, 0.2)
	noteTweenAlpha('noteAlphaTween2.8', 7, 1, 0.2)
